...
| [Google Dork Buttons](scripts/google-dork-buttons.user.js) | Adds one-click Google dork operator buttons under the Google search bar | `www.google.com` | not yet published |
<!-- scripts:end -->
